...
1. **Create Failing Test Case**
   ...
   - Use the `play-tdd` skill for writing proper failing tests
...
- **play-tdd** - For creating failing test case (Phase 4, Step 1)
- **play-verification** - Verify fix worked before claiming success
