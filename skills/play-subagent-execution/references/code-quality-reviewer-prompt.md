...
commit. Read-only proof result summaries remain ordinary task-completion
evidence inside `EXTRACTED_WHOLE_IMPLEMENTATION_CONTEXT`, not a receipt, ledger,
discharge state, or persistent artifact.
