...
Write source-specific evidence in a concise normalized form that preserves
enough provenance to evaluate it, such as author, timestamp, permalink when
available, and the substantive comment text or summary.
