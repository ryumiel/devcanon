# Behavior Spec Evidence Routing Runtime Reference

This is a packaged runtime reference for `write-product-spec`. Use it when the
installed skill cannot rely on repository-local DevCanon docs.

This reference summarizes the AFDS behavior-spec profile, evidence-pointer
rules, readiness-review handoff, and issue-slicing boundary for behavior-spec
authoring.
