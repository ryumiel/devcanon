...
const { requireExactSilentStdout, runRuntimeBackedHelper } = await import(
  "./runtime-adapter.mjs"
);
runRuntimeBackedHelper(
  scriptPath,
  ["issue-priming", "phase-artifacts", ...process.argv.slice(2)],
  (stdout) => requireExactSilentStdout(stdout, "phase-artifacts"),
);
