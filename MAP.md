...
- Where is profile guidance for conditional `contracts/`, `docs/harness/`, `docs/knowledge/`, `docs/references/`, `docs/roadmap/`, `docs/tech-debt/`, and module breadcrumbs? -> [`docs/guidelines/documentation-standard.md`](docs/guidelines/documentation-standard.md)
- Where are issue/spec relationships and work-origin routing defined? -> [`docs/guidelines/project-management-model.md`](docs/guidelines/project-management-model.md)
