...
- Where are product requirements? -> [`docs/product-requirements/`](docs/product-requirements/)
- Where are behavior specs? -> [`docs/specs/`](docs/specs/)
- Where is the behavior specs overview? -> [`docs/specs/overview.md`](docs/specs/overview.md)
...
- Where are AFDS mechanical documentation checks defined? ->
  [`docs/specs/afds-mechanical-documentation-checks.md`](docs/specs/afds-mechanical-documentation-checks.md)
...
- Where is AFDS setup and migration guidance? ->
  [`docs/guidelines/afds-setup-and-migration.md`](docs/guidelines/afds-setup-and-migration.md)
- Where is the AFDS pilot checklist? ->
  [`docs/guidelines/afds-pilot-checklist.md`](docs/guidelines/afds-pilot-checklist.md)
...
- Where is the canonical manifest boundary/full-tuple identity and managed component-collision owner? ->
  [`src/install/manifest-identity.ts`](src/install/manifest-identity.ts)
...
- Where is the runtime bundle entrypoint source? ->
  [`src/runtime/bundle-entry.ts`](src/runtime/bundle-entry.ts)
...
- Where is the trusted-bootstrap CLI source? ->
  [`src/runtime/bootstrap-cli.ts`](src/runtime/bootstrap-cli.ts)
...
- Where is the Linear project update writing skill? ->
  [`skills/write-linear-project-update/SKILL.md`](skills/write-linear-project-update/SKILL.md)
- Where is the Linear project description and brief writing skill? ->
  [`skills/write-linear-project-description/SKILL.md`](skills/write-linear-project-description/SKILL.md)
