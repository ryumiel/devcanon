...
| ------------------------------------------------------ | -------------------------------------------------------------------------------- | --------------------------------------------------------------------- | ------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------ |
| Raw idea or unclear product intent                     | Product requirements or another owning durable AFDS artifact                     | Issue comment, product discussion, or linked source note              | Shape the owning durable artifact                                  | Product goals, users, outcomes, risks, or open questions change                                                          | `Blocked: product intent owner is unclear.`                                    |
...
| Reusable workflow policy or procedure                  | Guideline, source skill, or source agent definition                              | Issue, PR note, or design artifact                                    | Update the owning guideline or source asset                        | Reusable procedure, trigger, workflow method, or role boundary changes                                                   | `Blocked: workflow policy owner is unclear.`                                   |
...
If a durable decision depends on unavailable evidence, the owning artifact may
record the durable decision and link to the accessible pointer, but it must not
copy private evidence or invent a local summary as substitute evidence.
...
The spec may identify follow-up surfaces that need classification after it
lands, but it must not approve new skills, agents, or governance artifacts.

Known follow-up surfaces for the owning capability-classification pass include:
