...
| D14 | Per-task spec review — `play-subagent-execution` review routing                       | `deep-reviewer`, frontier/xhigh, source-immutable                                                                                                                                                          | Existing distinct prompt/same-head fix loop                                                                                   |
| D15 | Per-task quality review — `play-subagent-execution` review routing                    | `deep-reviewer`, frontier/xhigh, source-immutable                                                                                                                                                          | Existing distinct prompt/provisional same-head loop                                                                           |
...
- the rendered full Codex model produced from the route capability;
