...
| `play-subagent-execution`          | inherited / normal      | source-mutable   | none               | Mutating tasks edit/commit; assessor proof tasks and reviews immutable      |
...
| D10 | Critic — `play-review` Phase 5                                                          | `deep-reviewer`, frontier/xhigh, source-immutable                                                                                                                                                          | Workflow-owned terminal disposition; controller retains critic verdicts; no recursion                                         |
...
| D16 | Final whole-implementation quality review — execution Process step 11/final-review gate | `deep-reviewer`, frontier/xhigh, source-immutable                                                                                                                                                          | Whole-range prompt; route-complete ADR-0016 skip; authority-owned recovery or terminal route                                  |
