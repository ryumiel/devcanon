...
Use this directory when a target state, sequencing model, or adoption direction
needs to survive beyond the current issue or agent session. Keep roadmap docs
focused on outcomes and ownership boundaries, not live execution state.
